...
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, ReferenceLine, ReferenceArea, ComposedChart, Line } from 'recharts';
...
export default function SentimentCharts({ recentSentiments, gaussianData, quantMetrics, regionalSentiment }: SentimentChartsProps) {
    return (
