            ...
            {auditStats && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5">
                    <div className="card p-4 flex flex-col gap-1" data-animate-child>
                        ...
                        <div className="text-[11px] text-[#7C7A6E]">correct predictions</div>
                    </div>
                    <div className="card p-4 flex flex-col gap-1" data-animate-child>
                        ...
                        <div className="text-[11px] text-[#7C7A6E]">per 15-day trade</div>
                    </div>
                    <div className="card p-4 flex flex-col gap-1" data-animate-child>
                        ...
                        <div className="text-[11px] text-[#7C7A6E]">worst single outcome</div>
                    </div>
                    <div className="card p-4 flex flex-col gap-1" data-animate-child>
                        ...
                        <div className="text-[11px] text-[#7C7A6E]">return / volatility</div>
                    </div>
                </div>
            )}

            {/* Prediction table */}
            <div className="bg-[#FFFFFF] rounded-2xl border border-[#DFDACB] overflow-hidden shadow-card" data-animate-child>
                <div className="overflow-x-auto">
                    <table className="w-full text-left data-table">
                        <thead className="bg-[#F5F3EB] border-b border-[#E5E1D5]">
                            <tr>
                                <th className="px-6 py-3 text-[11px] font-700 tracking-[0.08em] uppercase text-[#6E6C60]">Date</th>
                                <th className="px-6 py-3 text-[11px] font-700 tracking-[0.08em] uppercase text-[#6E6C60]">Signal</th>
                                <th className="px-6 py-3 text-[11px] font-700 tracking-[0.08em] uppercase text-[#6E6C60]">Horizon</th>
                                <th className="px-6 py-3 text-[11px] font-700 tracking-[0.08em] uppercase text-[#6E6C60] text-right">Score</th>
                                <th className="px-6 py-3 text-[11px] font-700 tracking-[0.08em] uppercase text-[#6E6C60] text-right">Entry</th>
                                <th className="px-6 py-3 text-[11px] font-700 tracking-[0.08em] uppercase text-[#6E6C60] text-right">Exit</th>
                                <th className="px-6 py-3 text-[11px] font-700 tracking-[0.08em] uppercase text-[#6E6C60] text-right">Return</th>
                                <th className="px-6 py-3 text-[11px] font-700 tracking-[0.08em] uppercase text-[#6E6C60]">Outcome</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-black/[0.05]">
                            {predictionHistory.map((pred: any, idx: number) => {
                                ...
                                return (
                                    <tr key={pred.id} className={idx % 2 === 0 ? 'bg-[#FFFFFF]' : 'bg-[#FAF8F2]'}>
                                        <td className="px-6 py-4 font-mono text-[12px] text-[#6E6C60]">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className="font-mono text-[11px] text-[#7C7A6E] border border-[#E5E1D5] px-2 py-0.5 rounded">{pred.horizon ?? 15}d</span>
                                        </td>
                                        <td className="px-6 py-4 text-right font-mono text-[13px] font-600 text-[#6E6C60]">
                                            {pred.composite_score?.toFixed(1) ?? '—'}
                                        </td>
                                        <td className="px-6 py-4 text-right font-mono text-[13px] font-600 text-[#2A2925]">
