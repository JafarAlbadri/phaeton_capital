        ...
        <section id="squeeze" className="scroll-mt-20" data-animate>
            <div className="flex items-center gap-3 mb-5">
                ...
                <span className={`px-3 py-1 rounded-lg text-[11px] font-700 border ${
                    ...
                    'bg-[#FAF9F5] border-[#E5E1D5] text-[#8F8C80]'
            ...
            <div className="card p-5">
                <div className="flex items-center gap-6 mb-4">
                    <div className="flex-1">
                        ...
                        <div className="h-2 rounded-full bg-[#EFECE1] border border-[#E5E1D5]">
                            <div className="h-full rounded-full transition-all" style={{
                                width: `${squeezeData.pressure_score}%`,
                                background: squeezeData.pressure_score >= 70 ? '#C24E42' : squeezeData.pressure_score >= 50 ? '#C05A2E' : squeezeData.pressure_score >= 30 ? '#C96442' : '#8F8C80'
                            }} />
                        </div>
                    </div>
                </div>
                <div className="grid grid-cols-3 gap-3">
                    <div className="bg-[#FAF9F5] rounded-xl border border-[#E5E1D5] p-3 text-center">
                    ...
                    <div className="bg-[#FAF9F5] rounded-xl border border-[#E5E1D5] p-3 text-center">
                        ...
                        <div className="font-mono text-[14px] font-700 text-[#6E6C60]">{squeezeData.shares_short ? `${(squeezeData.shares_short / 1e6).toFixed(1)}M` : '—'}</div>
                    </div>
                </div>
            </div>
        </section>
