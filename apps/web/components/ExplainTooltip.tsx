    ...
    >
      ...
      <div
        className={[
          ...
          "border border-[#D97757]/60 ring-1 ring-[#D97757]/20",
      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 px-6 py-4 border-b border-[#D97757]/25 bg-gradient-to-b from-[#12122a] to-[#0a0a1c]">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-2 h-2 rounded-full bg-[#E0906F] shadow-[0_0_8px_rgba(252,217,122,0.6)] flex-shrink-0" />
            <p className="text-[#E0906F] font-bold text-[15px] leading-snug truncate">
              {entry.title}
            </p>
          </div>
          <button
            onClick={onClose}
            className="text-[#A6A296] hover:text-[#E0906F] hover:bg-white/5 transition-colors flex-shrink-0 p-1.5 rounded-md border border-[#2a2a4a] hover:border-[#D97757]/50"
            aria-label="Close"
          >
        ...
        <div className="overflow-y-auto px-6 py-5 flex flex-col gap-4">
          ...
          <div>
            <p className="text-[#E0906F] text-[10.5px] font-bold tracking-[0.10em] uppercase mb-2">
              Why it matters
            </p>
            <p className="text-[#C7C3B8] text-[14px] leading-[1.65]">
              {entry.whyMatters}
            </p>
          </div>

          {entry.range && (
            <div className="bg-[#05051a] border border-[#3A3833] rounded-[10px] px-4 py-3 mt-1">
              <p className="text-[#7878a0] text-[10px] font-bold tracking-[0.10em] uppercase mb-1.5">
                Normal range
              </p>
              <p className="text-[#E0906F] font-mono text-[12px] leading-relaxed">
                {entry.range}
              </p>
            </div>
          )}
        ...
        {/* Footer hint */}
        <div className="px-6 py-3 border-t border-[#3A3833] bg-[#05051a]/60 text-center">
          <p className="text-[10px] text-[#7878a0]">
            Press{" "}
            <kbd className="px-1.5 py-0.5 rounded bg-[#3A3833] text-[#A6A296] font-mono border border-[#2a2a4a]">
              Esc
            </kbd>{" "}
